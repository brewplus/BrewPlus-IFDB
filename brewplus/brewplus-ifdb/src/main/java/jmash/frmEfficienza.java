...
public class frmEfficienza extends javax.swing.JInternalFrame {
    ...
    private final JVolumeSpinner volumeSpinnerBREWHOUSE;
    private final JGravitySpinner gravitySpinnerBREWHOUSE;
    private final JGravitySpinner gravitySpinnerPREBOIL;
