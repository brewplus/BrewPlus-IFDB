    ...
    private void BindaLista() {
        ...
        for (int i = 0; i < steps.size(); i++) {
            if (steps.get(i).getMinuto() < minutiTrascorsi) {
                layoutsteps += "<font color='#095422'>" + steps.get(i).getMinuto() + " " + steps.get(i).getDescrizione()
                        + "</font><br>";
            }
            if (steps.get(i).getMinuto() == minutiTrascorsi) {
                layoutsteps += "<font color='red'>" + steps.get(i).getMinuto() + " " + steps.get(i).getDescrizione()
                        + "</font><br>";
            }
            if (steps.get(i).getMinuto() > minutiTrascorsi) {
                layoutsteps += "<font color='#12943D'>" + steps.get(i).getMinuto() + " " + steps.get(i).getDescrizione()
                        + "</font><br>";
            }
        }
        layoutsteps += "</html>";
