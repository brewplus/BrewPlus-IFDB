...
public class BreweryProfilePickerTableModel extends PickerTableModel {
    ...
    String columnNames[] = { "Nome", "Descrizione", "Volume finale", "Efficienza", "Assorb. grani esausti", "DeadSpace", "Rapp. acqua/grani", "% evaporazione", "Contraz. x raffred.", "Perdite trub", "BIAB" };
	...
	if (breweryProfile != null) {
	    ...
	    case 6:
		return breweryProfile.getDeadSpace();
	    case 5:
