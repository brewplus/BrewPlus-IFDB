...
public class MashStep implements Comparable<Object> {
	...
	private static String campiXml[] = { "type", "start", "startTemp", "endTemp", "length", "nome", "ramp",
			"decoctionRamp1", "decoctionRamp2", "decoctionRestL1", "decoctionRestL2", "decoctionRestT1",
			"decoctionRestT2", "decoctionRampDown", "infusionTemp" };
