...
public class TableSorter extends AbstractTableModel {
     ...
     * 
     */
    private static final long serialVersionUID = 892728200331992788L;
    ...
    public void setColumnComparator(Class<? extends Object> type, Comparator<? extends Object> comparator) {
        if (comparator == null) {
    ...
    private class TableModelHandler implements TableModelListener {
        ...
        public void tableChanged(TableModelEvent e) {
            ...
            if ((e.getFirstRow() == e.getLastRow()) && (column != TableModelEvent.ALL_COLUMNS) && (getSortingStatus(column) == NOT_SORTED) && (TableSorter.this.modelToView != null)) {
