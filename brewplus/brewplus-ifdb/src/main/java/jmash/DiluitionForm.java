...
public class DiluitionForm extends javax.swing.JInternalFrame {
	...
	public void calculate() {
		...
		this.sg3 = Utils.Plato2SG(
				(this.litri1 * Utils.SG2Plato(this.sg1) + this.litri2 * Utils.SG2Plato(this.sg2)) / this.litri3);
	...
	public static Image bgImage = java.awt.Toolkit.getDefaultToolkit()
