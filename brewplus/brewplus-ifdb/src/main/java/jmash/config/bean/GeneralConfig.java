...
public class GeneralConfig {
    ...
    private Integer metriSLM;
    private Integer amaroDHEA;
	...
	public String getBUGUratiostring() {
		return BUGUratiostring;
	}
	public void setBUGUratiostring(String bUGUratiostring) {
		BUGUratiostring = bUGUratiostring;
	}
